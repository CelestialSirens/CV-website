...
<div class="main">
    <section id="genesis">
        ...
        <img id="mainImg" src="../Assets/MyPfp.png" alt="myImg" width="300" height="300">
...
<div class="main">
    <section id="about-me">
        ...
        <h2> My knowledge </h2>
        <p> Whilst being @Aston, I've learnt In depth knowledge on Linux & Windows Kernel processes and operations understand the complex differences between User system calls & Kernel level </p>
